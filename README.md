...
**96 open roles · 60 new this week · 3,855 companies tracked · updated Jul 22, 2026 at 17:17 UTC**
...
_~ = the title doesn't state a year; bucketed here from its posting date (45 of 65)._
...
|---|---|---|---|
| SS&C | Healthcare AI & Automation Intern | Summer 2027 | 2026-07-22 |
...
_Engine (last run): 3,855 companies across 12 ATS platforms · 98% fetch success · completed in 272.0s · median detection latency 1040 min · real posted dates on 100% of open roles._
