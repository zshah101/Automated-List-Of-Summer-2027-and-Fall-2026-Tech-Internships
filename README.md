...
### 921 open roles (587 listed below) · 194 new this week

4,607 employers tracked · data as of Sep 20, 2026 at 21:02 UTC
...
_Engine (last run): 4,398 of 4,866 registered boards returned successfully across 12 ATS platforms (96% of boards attempted, 90% of the full registry) · completed in 1066.1s · 564 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 99% of open roles._
